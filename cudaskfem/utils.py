...
from cudaskfem.assembly import asm, BilinearForm, LinearForm, DofsView
from cudaskfem.assembly.basis import AbstractBasis
...
def projection(fun,
    ...
    @BilinearForm
    def mass(u, v, w):
        from cudaskfem.helpers import dot, ddot
        p = 0
        if len(u.shape) == 2:
            p = u * v
        elif len(u.shape) == 3:
